...
android {
    namespace = "com.schedulersystems.scheduler"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.schedulersystems.scheduler"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"

        testInstrumentationRunner = "com.schedulersystems.scheduler.HiltTestRunner"
        vectorDrawables {
