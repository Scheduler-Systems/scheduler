...
export default function LoginPage() {
  ...
  // Route through email verification if the signed-in user hasn't
  // verified — matches Flutter's LoginEmail flow.
  function routeAfterSignIn(email?: string) {
    ...
    <div className="auth-card-shell">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">{t("login.subheading")}</p>
        </div>
